...
# Usage: ./run_cifar100_resnet20_squat.sh METHOD_TYPE
# Example: ./run_cifar100_resnet20_squat.sh "SQuaT/W1A1/"
#########################################################################################################
...
then
    python train_fp.py --gpu_id '0' \
                    ...
                    --epochs 720 \
                    --log_dir './results/CIFAR100_ResNet20/'$METHOD_TYPE
...
then
    python train_quant_distill.py --gpu_id '0' \
                                ...
                                --kd_beta 1.0 \
                                --kd_gamma 1.0 \
                                --pretrain_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --teacher_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --log_dir './results/CIFAR100_ResNet20/SQuaT/W1A1/' \
                                --resume './results/CIFAR100_ResNet20/SQuaT/W1A1/checkpoint/last_checkpoint.pth'
...
then
    python train_quant_distill.py --gpu_id '0' \
                                ...
                                --pretrain_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --teacher_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --log_dir './results/CIFAR100_ResNet20/SQuaT/W2A2/' \
                                --resume './results/CIFAR100_ResNet20/SQuaT/W2A2/checkpoint/last_checkpoint.pth'
...
then
    python train_quant_distill.py --gpu_id '0' \
                                ...
                                --pretrain_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --teacher_path './results/CIFAR100_ResNet20/fp/checkpoint/best_checkpoint.pth' \
                                --log_dir './results/CIFAR100_ResNet20/SQuaT/W4A4/' \
                                --resume './results/CIFAR100_ResNet20/SQuaT/W4A4/checkpoint/last_checkpoint.pth'
